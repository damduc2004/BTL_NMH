...
CREATE OR REPLACE DIRECTORY data_file_dir AS 'C:\app09\oracle\base\product\19.0.0\dbhome_1\demo\schema\sales_history\'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS 'C:\app09\oracle\base\product\19.0.0\dbhome_1\demo\schema\log\'; 
CREATE OR REPLACE DIRECTORY media_dir     AS 'C:\app09\oracle\base\product\19.0.0\dbhome_1\demo\schema\product_media\';
